...
export const ShoppingBagIcon = withCustomIcon(({ status }: IconProps) => {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <circle cx="12" cy="6" r="4.25" stroke={status} strokeWidth="1.5"/>
      <path 
        ...
        strokeWidth="1.5"
      />
      <circle cx="9.75" cy="10.75" r="0.75" fill={status} />
      <circle cx="13.75" cy="10.75" r="0.75" fill={status} />
    </svg>
  );
});
